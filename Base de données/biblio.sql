...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 04 juin 2024 à 20:20
...
INSERT INTO `client` (`id_client`, `nom_client`, `Email`, `date_naissance`, `adresse`, `Nb_emprunt`, `Date_inscription`, `MDP`, `numero_telephone`) VALUES
(1, 'youssef', 'Jalil_Jerf@email.com', '1995-10-31', 'youssef', 2, '2016-02-01', 'youssef', NULL),
(2, 'Dadso', 'Haitham_Dadso@email.com', '1995-06-15', 'LAAAAAATER', 0, '2015-12-31', 'Seeerfie', NULL),
(3, 'Faraby', 'Yusuf_Faraby@email.com', '1994-12-25', 'Boulevard Bouchaib Doukali Num 15, Casablanca', 0, '2016-03-01', 'FarFar', NULL),
(4, 'JY-7', 'Youssef7jabbari@email.com', '1995-10-31', 'Boulevard El Fida Num 9, Casablanca', 5, '2007-07-07', 'ZarakiDono', NULL),
(5, 'Nkir', 'Dounia_Nkir@email.com', '1994-04-24', 'Boulevard Boulevard Num N, Casablanca', 0, '2016-03-21', 'NkirNkir', NULL),
(6, 'Mellouki', 'Zakaria_Mellouki', '1995-09-19', 'Boulevard BLVRD Num N, Casablanca', 0, '1995-09-19', 'JESUISZAK', NULL),
(8, 'youssef', 'Youssef.Faraby13', '2016-04-28', 'youssef', 0, NULL, 'youssef', NULL),
(9, 'youssef faraby', 'youssef@faraby.com', '2016-04-06', 'boulvar & 1', 0, '2016-04-17', '1234567', NULL),
(10, 'bouhaddioui', 'manar@gmail.com', '1995-06-11', 'boulvard la resistance ', 1, '2016-04-22', '123456789', NULL),
(11, 'Hidan', 'kill_yourself@email.com', '1986-06-06', 'machi so9ek ^^', 0, '2016-05-03', 'kill', NULL),
(12, 'MED', 'user', '2024-06-11', 'keni one love ', 1, '2024-06-02', '123', '0600000000'),
(13, 'med', 'MED', '2024-06-18', 'keni one love ', 0, '2024-06-02', '123', '653638047'),
(14, 'med', 'MED', '2024-06-18', 'keni one love ', 0, '2024-06-02', '123', '653638047'),
(15, 'MOHAMMED', 'med@med.co', '1997-05-30', 'keni one love ', 1, '2024-06-03', 'Cossic/123', '653638047'),
(16, 'MOHAMMED', 'user@user.com', '2008-03-06', 'keni one love ', 2, '2024-06-04', '123456', '6536373838'),
(17, 'MOHAMMED', 'user@user.co', '2010-06-23', 'keni one love ', 1, '2024-06-04', '123456', '6000000');
...
(12, 'Premiers pas en CSS et HTML', 'Informatique', 'EYROLLES', 1, 'ouvrages\\Html_Css.jpg', 'informatique etage 5 NUm 1', 'Aucune Information'),
...
ALTER TABLE `emprunter`
  ...
  ADD KEY `id_client` (`id_client`,`ISBN`,`id_emprunt`),
  ADD KEY `ISBN` (`ISBN`),
  ADD KEY `date_emprunt` (`date_emprunt`);
...
--
ALTER TABLE `auteur`
  MODIFY `id_auteur` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT pour la table `client`
--
ALTER TABLE `client`
  MODIFY `id_client` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT pour la table `emprunter`
--
ALTER TABLE `emprunter`
  MODIFY `id_emprunt` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT pour la table `livre`
--
ALTER TABLE `livre`
  MODIFY `ISBN` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
